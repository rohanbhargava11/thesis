...
My algorithm uses the EM algorithm to calculate the most likely parameters for a data set.  The trajectories are calculated by implementing particle filtering and smoothing.  Particle Filters are chosen because they can model non-linear transformations. Particle smoothing was performed because Russel and Norving ~\cite{russell2003artificial} pointed out that the state of the system is better estimated by smoothing as it incorporates information from all the past states of the system. 
...
\begin{tabular}{|r|r|}
    ...
    \hline
\end{tabular}
 \caption{\label{tab-constant parameters}Summary of the simulations performed to adapt motion model.}
\end{table}
...
At the start of the simulation  the initial location of the robot and particle filters are randomly initialized. The robot is moved by a constant velocity and Figure ~\ref{fig-: movement simulation world} shows the updated location of the robot as well as an estimate by particle filters of the robot's location.
\begin{figure}
  \centering
...
\begin{figure}[!ht]
  \centering
     \subfigure[]{\includegraphics[width= 2.2 in]{./plots/200_005_05_s_10_motion_model_trans.pdf}}\qquad
     \subfigure[]{\includegraphics[width = 2.2 in]{./plots/200_005_05_s_10_motion_model_rotation.pdf}}
...
\begin{figure}[!h]
  \centering
     \subfigure[]{\includegraphics[width = 2.2 in]{./plots/200_005_10_s_10_motion_model_trans.pdf}}\qquad
     \subfigure[]{\includegraphics[width = 2.2 in]{./plots/200_005_10_s_10_motion_model_rotation.pdf}}
...
In the first two simulations to simulate changes in the environment we changed $\sigma_{V_{v}}^2$. In the next two simulations we induce drift in the system and compare both motion models in terms of localization error.
...
\begin{figure}[!ht]
  \centering
     \subfigure[]{\includegraphics[width = 2.2 in]{./plots/200_005_005_s_10_traj_3_drift_20_motion_model_trans.pdf}}
	 \subfigure[]{\includegraphics[width = 2.2 in]{./plots/200_005_005_s_10_traj_3_drift_20_motion_model_rotation.pdf}}	  
...
\begin{figure}[!ht]
  \centering
     \subfigure[]{\includegraphics[width = 2.2 in]{./plots/200_005_05_s_10_100_100_traj_3_trial_1_motion_model_trans.pdf}}
     \subfigure[]{\includegraphics[width = 2.2 in]{./plots/200_005_05_s_10_100_100_traj_3_trial_1_motion_model_rotation.pdf}}
...
in estimating distance moved by AUV. 
