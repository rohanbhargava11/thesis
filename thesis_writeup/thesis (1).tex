...
\begin{figure}
  \centering
     {\includegraphics[height = 3.0 in]{/home/rohan/Documents/thesis_work/uav_diagram.png}}
  \caption{\label{fig-Coordinate System} Body-fixed reference frames. Figure from \cite{Thor}
}
\end{figure}
